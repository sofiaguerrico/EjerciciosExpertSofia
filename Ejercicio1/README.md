...
/*
RESPUESTA:
El código Libro.cs no respeta el principio de responsabilidad única, ya que el método ShelveBook puede ser considerada una clase independiente la cual tiene la responsabilidad de conocer los libros que almacena y en qué sector se encuentran, haciendo de dicha forma una interacción con la clase Book. 
*/
